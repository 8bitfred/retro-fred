...
class StateMainMenu : public BaseState
{
    ...
    void render(FredApp const &app) const final
    {
        ...
        tmgr.renderText(renderer, "WRITTEN BY FERNANDO RADA,", 0, 104, 206, 206, 206);
        tmgr.renderText(renderer, "PACO MENENDEZ & CARLOS GRANADOS.", 0, 112, 206, 206, 206);
        tmgr.renderText(renderer, "       \x7f INDESCOMP SPAIN", 0, 120, 206, 206, 206);
        tmgr.renderText(renderer, "PRESENTED BY QUICKSILVA", 0, 128, 206, 206, 206);
        tmgr.renderText(renderer, "PRESENTATION SCREEN DESIGN:", 0, 136, 206, 206, 206);
        tmgr.renderText(renderer, "JUAN DELCAN, KIKI & MA", 0, 144, 206, 206, 206);
        tmgr.renderText(renderer, "CHARACTER DESIGN: GAELIC", 0, 152, 206, 206, 206);
        tmgr.renderText(renderer, "PET: SENATOR & DRULY'S DUCK", 0, 160, 206, 206, 206);
        tmgr.renderText(renderer, "MISTAKES: MARTA & PALOMA", 0, 168, 206, 206, 206);
        tmgr.renderText(renderer, "2023 PORT:  MIGUEL CATALINA &", 0, 176, 206, 206, 206);
        tmgr.renderText(renderer, "            ALFREDO CATALINA", 0, 184, 206, 206, 206);
